  ...
  const verifiedDocs = [
    {
      ...
      ledgerId: "PHIL-8F2A-2026",
      ref: "EVR-8F2A-19C0-2026",
      details: "Official PhilSys Digital Identity matched against central registry database.",
      tone: "green",
      Icon: UserCheck,
      badgeBg: "#e0e7ff",
  ...
  return (
    <>
      <Head
        ...
        text="A central inventory of all official documents, credentials, and digital seals linked to your profile."
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "1.75rem", gap: "1rem", flexWrap: "wrap" }}>
        ...
        <div style={{ position: "relative", width: "100%", maxWidth: 300 }}>
          <input
            placeholder="Search credential or reference..."
            value={searchTerm}
            ...
            >
              <div style={{ width: "100%", display: "flex", flexDirection: "column", alignItems: "center" }}>
                ...
                <div style={{ background: "#f5f3ff", padding: "0.85rem 1rem", borderRadius: 16, border: "2px solid #1e1b4b", width: "100%", display: "flex", flexDirection: "column", gap: "0.35rem", fontSize: "0.82rem", fontWeight: 800, marginBottom: "1.25rem", textAlign: "left", boxSizing: "border-box" }}>
                  ...
                  <div style={{ display: "flex", justifyContent: "space-between" }}>
                    <span style={{ color: "#4338ca" }}>Credential ID:</span>
              ...
              <div style={{ width: "100%" }}>
                ...
                >
                  <FileCheck2 size={18} /> View Certified Details <ChevronRight size={18} />
                </button>
              </div>
            </div>
          );
          ...
          >
            ...
            {selectedDoc.imageSrc && (
              <div style={{ marginBottom: "1.25rem", borderRadius: 20, border: "2.5px solid #1e1b4b", overflow: "hidden", boxShadow: "0 4px 0 #1e1b4b" }}>
                <img src={selectedDoc.imageSrc} alt={selectedDoc.title} style={{ width: "100%", height: 200, objectFit: "cover" }} />
              </div>
            )}
            ...
            <div style={{ background: "#f5f3ff", padding: "1.25rem", borderRadius: 20, border: "2.5px solid #1e1b4b", marginBottom: "1.25rem", display: "flex", flexDirection: "column", gap: "0.6rem", fontSize: "0.88rem", fontWeight: 700 }}>
              ...
              <div><b>Credential ID:</b> <b>{selectedDoc.ledgerId}</b></div>
            ...
            <div style={{ textAlign: "center", marginBottom: "1.25rem", padding: "1rem", background: "#ffffff", borderRadius: 16, border: "2px solid #1e1b4b" }}>
              ...
              <small style={{ display: "block", fontSize: "0.75rem", color: "#4338ca", fontWeight: 800, marginTop: "0.5rem" }}>Scan QR to verify authentic agency seal</small>
            </div>
