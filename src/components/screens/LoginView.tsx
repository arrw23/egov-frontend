    ...
    <div className="login">
      <header>
        ...
        <span style={{ fontSize: "0.85rem", fontWeight: 800, color: "#1e1b4b", display: "flex", gap: "0.4rem", alignItems: "center" }}>
          <LockKeyhole size={16} /> eGovPH SSO Connected (HACKATHON_SSO)
        </span>
      </header>
      <div className="loginGrid">
        <section>
          <div style={{ background: "#fef08a", color: "#1e1b4b", padding: "0.4rem 1rem", borderRadius: "9999px", border: "2px solid #1e1b4b", fontWeight: 900, fontSize: "0.75rem", display: "inline-block", marginBottom: "1rem" }}>
            REPUBLIC OF THE PHILIPPINES · eGOV INTEGRATED
          </div>
          <h1>
            Medical assistance,
            <br />
          ...
          <p style={{ fontSize: "1.1rem", fontWeight: 600, color: "#4338ca", lineHeight: 1.5 }}>
            One unified digital case connecting Filipino citizens, hospitals, and government assistance agencies.
          </p>
          ...
          <div style={{ marginTop: "1.5rem", background: "#ffffff", padding: "1.25rem", borderRadius: 20, border: "2.5px solid #1e1b4b", boxShadow: "0 4px 0 #1e1b4b" }}>
            <div style={{ fontSize: "0.78rem", fontWeight: 900, color: "#6366f1", letterSpacing: "0.08em", marginBottom: "0.6rem" }}>
              eGovPH SSO COMPLIANCE CHECKLIST
            </div>
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "0.5rem", fontSize: "0.82rem", fontWeight: 800 }}>
              <span style={{ color: "#059669", display: "flex", alignItems: "center", gap: "0.35rem" }}><Check size={14} /> Base URL: /egovph/sso</span>
              <span style={{ color: "#059669", display: "flex", alignItems: "center", gap: "0.35rem" }}><Check size={14} /> Auto-Login Enabled</span>
              <span style={{ color: "#059669", display: "flex", alignItems: "center", gap: "0.35rem" }}><Check size={14} /> Profile Locking (Read-Only)</span>
              <span style={{ color: "#059669", display: "flex", alignItems: "center", gap: "0.35rem" }}><Check size={14} /> Data Sync (UniqID & Details)</span>
            </div>
          </div>
          ...
          <div style={{ marginTop: "1.5rem", display: "flex", flexDirection: "column", gap: "0.85rem" }}>
            <div style={{ display: "flex", gap: "1rem", alignItems: "center" }}>
              ...
              <span style={{ fontWeight: 800, color: "#1e1b4b", fontSize: "0.95rem" }}>Verified Identity <small style={{ display: "block", color: "#4338ca", fontWeight: 600 }}>Powered by PhilSys eVerify</small></span>
            </div>
            <div style={{ display: "flex", gap: "1rem", alignItems: "center" }}>
        ...
        <aside>
          ...
          <a
            href="/egovph/sso?exchange_code=HACKATHON_SSO_LIVE"
            className="primary wide"
            style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: "0.6rem", textDecoration: "none", marginBottom: "1.5rem", padding: "0.9rem 1.25rem", borderRadius: "9999px" }}
          >
          ...
          <div style={{ textAlign: "center", fontSize: "0.8rem", color: "#6366f1", fontWeight: 800, marginBottom: "1rem" }}>
            — OR SIMULATE DEMO ROLE PORTAL —
          </div>

          {([
            ["applicant", UserRound, "Citizen / Applicant Portal", "Josie Santos Dela Cruz (josie@yopmail.com)", "#e0e7ff"],
            ["hospital_staff", Hospital, "Hospital Staff Portal", "Dr. Ana Reyes (Manila General Hospital)", "#dcfce7"],
